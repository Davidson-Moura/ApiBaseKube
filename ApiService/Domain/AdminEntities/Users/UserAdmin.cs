...
{
    public class UserAdmin : PostgresEntity
    {
    ...
    public class UserAdminFilter : PGFilterBase<UserAdmin>
    {
        public string? Name { get; set; }
        public string? Email { get; set; }
        public string? EmailEq { get; set; }
        public override IQueryable<UserAdmin> ApplyFilter(IQueryable<UserAdmin> query)
        {
